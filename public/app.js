...
const translations = {
  ...
  en: {
    ...
    whisper4:
      'Ocean Whisper audio — a recording of the sea, created for your moment',

    whisper5:
      'One atmospheric photograph from the shore',
    ...
    portal7:
      'Your personal Ocean Message — spoken and recorded during the ritual.<br>This is not a recording you receive from a library. It is a moment created specifically for you.',
  ...
  sl: {
    ...
    whisper4:
      'Ocean Whisper zvočni posnetek — posnetek morja, ustvarjen za tvoj trenutek',

    whisper5:
      'Ena atmosferična fotografija z obale',
    ...
    portal5:
      'Šepetalka Oceanskih Školjk',

    portal6:
      'Aqua Lemu Reiki ritual',

    portal7:
      'Tvoje osebno Oceansko sporočilo — izgovorjeno in posneto med ritualom.<br>To ni posnetek, ki ga prejmeš iz knjižnice. To je trenutek, ustvarjen posebej zate.',
